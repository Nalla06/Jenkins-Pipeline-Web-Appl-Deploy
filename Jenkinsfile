pipeline {
    ...
    environment {
        ...
        APP_REPO_NAME = "clarusway-repo/Jenkins-Pipeline-Web-Appl-Deploy"
    }
    stages {
        ...
        stage('Deploy the App') {
            steps {
                ...
                ansiblePlaybook credentialsId: 'linux-key-pair', disableHostKeyChecking: true, installation: 'ansible', inventory: 'inventory_aws_ec2.yml', playbook: 'docker_project.yml'
             }
        }
